...
import { drivetrainOptions, fuelOptions, getEngineOptions, transmissionOptions, vehicleMakes, vehicleModels, yearOptions } from './vehicleCatalog.js';
import './admin.css';

    ...
    <div className="admin-view">
      ...
      <details className="admin-filter-panel">
        ...
        <div className="admin-filter-grid">
          ...
          <SelectField label="Year" ariaLabel="Filter by year" name="yearFilter" value={filters.year} onChange={(event) => updateFilter('year', event.target.value)} options={['all', ...options.years.map(String)]} optionLabels={{ all: 'All years' }} searchable={false} />
          <SelectField label="Drivetrain" ariaLabel="Filter by drivetrain" name="drivetrainFilter" value={filters.drivetrain} onChange={(event) => updateFilter('drivetrain', event.target.value)} options={['all', ...options.drivetrains]} optionLabels={{ all: 'All drivetrains' }} searchable={false} />
          <SelectField label="Transmission" ariaLabel="Filter by transmission" name="transmissionFilter" value={filters.transmission} onChange={(event) => updateFilter('transmission', event.target.value)} options={['all', ...options.transmissions]} optionLabels={{ all: 'All transmissions' }} searchable={false} />
          <SelectField label="Fuel type" ariaLabel="Filter by fuel type" name="fuelFilter" value={filters.fuel} onChange={(event) => updateFilter('fuel', event.target.value)} options={['all', ...options.fuels]} optionLabels={{ all: 'All fuel types' }} searchable={false} />
          <SelectField label="Engine" ariaLabel="Filter by engine" name="engineFilter" value={filters.engine} onChange={(event) => updateFilter('engine', event.target.value)} options={['all', ...options.engines]} optionLabels={{ all: 'All engines' }} searchable={false} />
          <SelectField label="Exterior color" ariaLabel="Filter by exterior color" name="exteriorColorFilter" value={filters.exteriorColor} onChange={(event) => updateFilter('exteriorColor', event.target.value)} options={['all', ...options.exteriorColors]} optionLabels={{ all: 'All exterior colors' }} searchable={false} />
          <SelectField label="Interior color" ariaLabel="Filter by interior color" name="interiorColorFilter" value={filters.interiorColor} onChange={(event) => updateFilter('interiorColor', event.target.value)} options={['all', ...options.interiorColors]} optionLabels={{ all: 'All interior colors' }} searchable={false} />

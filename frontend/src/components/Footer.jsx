  ...
  return (
    <footer className="footer">
      <div className="page-width footer-main">
        ...
        <div className="footer-social"><a href={dealership.instagram} target="_blank" rel="noreferrer"><Icon name="instagram" />Instagram</a><a href={dealership.tiktok} target="_blank" rel="noreferrer"><Icon name="tiktok" />TikTok</a><a href={`https://wa.me/${dealership.whatsapp}`} target="_blank" rel="noreferrer"><Icon name="whatsapp" />WhatsApp</a><a href={dealership.location} target="_blank" rel="noreferrer"><Icon name="location" />Location</a></div>
      </div>
